...
class DQNAgent:
    ...
    def __init__(self, nb_states, nb_actions, REPLAY_MEMORY_SIZE, BATCH_SIZE, DISCOUNT, LEARNING_RATE,EPI_START, EPI_END, epsilon_decay,device):       #生成agent的参数
        ...
        self.memory = ReplayMemory(self.replay_memory_size,self.device)                  #随机生成50000容量的经验池
